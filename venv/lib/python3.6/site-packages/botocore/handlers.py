...
def check_for_200_error(response, **kwargs):
    ...
    #
    # So this handler checks for this case.  Even though the src sends a
...
def sse_md5(params, **kwargs):
    """
    S3 src-side encryption requires the encryption key to be sent to the
    src base64 encoded, as well as a base64-encoded MD5 hash of the
