...
class CommonRequestDescriptorsMixin(object):
    ...
    referrer = environ_property(
        ...
        to specify, for the src's benefit, the address (URI) of the
...
class CommonResponseDescriptorsMixin(object):
    ...
    age = header_property(
        ...
        revalidation) was generated at the origin src.
    ...
    last_modified = header_property(
        ...
        and time at which the origin src believes the variant was
        last modified.""",
    )
